    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="w-full max-w-md p-6 mx-4 bg-white rounded-lg shadow-xl dark:bg-gray-800">
        ...
        <div className="mb-6">
          ...
          <div className="mb-4">
            <label htmlFor="shares" className="block mb-1 text-sm font-medium text-gray-700 dark:text-gray-300">
              Number of Shares
            </label>
            <input
              type="number"
          ...
          <div className="p-3 mb-4 bg-gray-50 rounded-md dark:bg-gray-700">
            <div className="flex justify-between">
              ...
              <div className="font-medium text-gray-900 dark:text-white">{formatCurrency(transactionTotal)}</div>
            </div>
          </div>

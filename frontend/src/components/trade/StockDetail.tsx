  ...
  return (
    ...
    >
      ...
      <div className="flex-1 mb-4">
        <div
          className="bg-gray-100 dark:bg-gray-700 rounded-lg p-4 h-[200px] flex items-center justify-center mb-3"
          aria-label={`Price chart for ${stock.symbol} over ${timeFrame} period`}
        >
      ...
      >
        <div className="bg-gray-50 dark:bg-gray-700 p-3 rounded-md">
          ...
          <div
            ...
            aria-label={`Previous close ${formatCurrency(stock.previousClose)}`}
          >
        ...
        <div className="bg-gray-50 dark:bg-gray-700 p-3 rounded-md">
          ...
          <div
            className="text-sm font-medium text-gray-900 dark:text-white"
            aria-label={`Market capitalization ${formatCurrency(stock.marketCap)}`}
          >

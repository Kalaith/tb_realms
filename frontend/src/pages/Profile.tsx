        ...
        {profile && !isEditing ? (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="col-span-1 flex flex-col items-center space-y-4">
              ...
              <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-200">{profile.fullName}</h2>
            ...
            <div className="col-span-2 space-y-4">
              <div className="p-4 bg-gray-50 rounded-lg dark:bg-gray-700">
                <h3 className="text-lg font-medium text-gray-800 dark:text-gray-200 mb-3">About Me</h3>
                <p className="text-gray-600 dark:text-gray-400">{profile.bio || 'No bio available'}</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="p-4 bg-gray-50 rounded-lg dark:bg-gray-700">
                  <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Experience Level</h3>
                  <p className="text-gray-800 dark:text-gray-200 capitalize">{profile.experience || 'Not specified'}</p>
                </div>
                
                <div className="p-4 bg-gray-50 rounded-lg dark:bg-gray-700">
                  <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Social Links</h3>
                  <div className="flex space-x-3">
                    {profile.twitterHandle && (
                      <a href={`https://twitter.com/${profile.twitterHandle.replace('@', '')}`} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">
                        Twitter
                      </a>
                    )}
                    {profile.linkedinProfile && (
                      <a href={`https://www.${profile.linkedinProfile}`} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">
                        LinkedIn
                      </a>
                    )}
                  </div>

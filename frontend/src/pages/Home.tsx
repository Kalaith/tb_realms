      ...
      {!isAuthenticated && (
        <div className="p-6 bg-blue-50 rounded-lg shadow dark:bg-gray-800 dark:border dark:border-blue-900">
          ...
          <p className="mb-4 text-gray-600 dark:text-gray-300">
            Track stocks, build your portfolio, and compete on the leaderboard in our 
            simulated trading environment. Sign up to get started!
          </p>
          <div className="flex flex-wrap gap-4">
            <Link to="/register" className="px-6 py-3 text-white bg-blue-600 rounded-md hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600">
              Sign Up Now
            </Link>
            <Link to="/login" className="px-6 py-3 text-blue-600 bg-white border border-blue-600 rounded-md hover:bg-blue-50 dark:text-blue-400 dark:bg-gray-700 dark:border-blue-400 dark:hover:bg-gray-600">
              Sign In
            </Link>
          </div>
        </div>

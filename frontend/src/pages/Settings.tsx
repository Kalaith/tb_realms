    ...
    const fetchSettingsCategories = async () => {
      try {
        ...
        if (response.success && response.data) {
          ...
          setCategoriesError(
            "Failed to load settings categories. Please try refreshing the page.",
          );
        }
      } catch (error) {
        console.error("Failed to fetch settings categories:", error);
        setCategoriesError(
          "An error occurred while loading settings categories.",
        );
      } finally {
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-gray-600 dark:text-gray-400 max-w-3xl">
        Customize your game experience. These settings focus on visual cues and
        performance optimizations for playing in real-time with thousands of
        other players.
      </p>

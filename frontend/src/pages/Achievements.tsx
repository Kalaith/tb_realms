    ...
    return (
      <div className="space-y-6">
        <div className="text-center mb-8">
          <p className="mt-2 text-gray-600 dark:text-gray-400">Track your progress and earn badges as you master stock trading</p>
        </div>
      ...
      {stats && (
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3 mb-8">
          <div className="p-6 bg-white rounded-lg shadow-md dark:bg-gray-800">
            <h3 className="mb-2 text-sm font-medium text-gray-500 dark:text-gray-400">Achievements Unlocked</h3>
          ...
          <div className="p-6 bg-white rounded-lg shadow-md dark:bg-gray-800">
            <h3 className="mb-2 text-sm font-medium text-gray-500 dark:text-gray-400">Completion</h3>
            <div className="text-2xl font-bold text-gray-900 dark:text-white">{stats.completionPercentage}%</div>
          </div>
          
          <div className="p-6 bg-white rounded-lg shadow-md dark:bg-gray-800">
            <h3 className="mb-2 text-sm font-medium text-gray-500 dark:text-gray-400">Points Earned</h3>
            <div className="text-2xl font-bold text-gray-900 dark:text-white">
          ...
          >
            <div className="p-5">
              <div className="flex items-center mb-4">
                <div className={`${achievement.unlocked ? 'text-green-500 dark:text-green-400' : 'text-gray-400 dark:text-gray-500'} mr-3`}>
                  <AchievementIcon 
              ...
              <div className="flex justify-between items-center mb-3">
                <span className={`inline-flex items-center px-2 py-1 text-xs font-medium rounded-md ${
                  ...
                  {achievement.achievement.difficulty.charAt(0).toUpperCase() + achievement.achievement.difficulty.slice(1)}
                </span>
              ...
              {!achievement.unlocked && (
                <div className="mt-4">
                  <div className="flex justify-between items-center mb-1 text-xs text-gray-600 dark:text-gray-300">
                    <span>Progress</span>
                    <span>{achievement.progress} / {achievement.achievement.requirement.threshold}</span>
                  </div>
